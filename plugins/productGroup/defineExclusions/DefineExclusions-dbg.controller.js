...
sap.ui.define([
	...
	return Controller.extend("retail.pmr.promotionaloffers.plugins.productGroup.defineExclusions.DefineExclusions", {
		...
		onInit: function() {
			...
			this.productsHierarchyTableController = controllerById(this, "productHierarchyExcluded");
		...
		setProductGroupData : function(data, IsNew) {	
			...
			this.productsTableController.setProductGroupData(data, false);
			this.productsHierarchyTableController.setProductGroupData(data);
		},
		resetProductHierarchy: function(){
			this.productsHierarchyTableController.resetExcludes();
		},
